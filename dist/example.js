...
/******/ 	var hotCurrentHash = "e55067f7007a30b5f8b5"; // eslint-disable-line no-unused-vars
...
const rect1Touch = Object(_src__WEBPACK_IMPORTED_MODULE_0__["GestureFactory"])({
...
const rect2Touch = Object(_src__WEBPACK_IMPORTED_MODULE_0__["GestureFactory"])({
    gestureType: _src__WEBPACK_IMPORTED_MODULE_0__["Types"].GestureType.TouchClick,
    options: {
...
class AbstractHammerGesture extends _abstract_gesture__WEBPACK_IMPORTED_MODULE_2__["AbstractGesture"] {
    constructor(element, options) {
        if (!elements.has(element)) {
            elements.set(element, new hammerjs__WEBPACK_IMPORTED_MODULE_0___default.a(element));
        }
    ...
    _checkEvent(event) {
        return (
            (event.pointerType === 'mouse') === (this._options.source === _constants__WEBPACK_IMPORTED_MODULE_1__["InputType"].any || this._options.source === _constants__WEBPACK_IMPORTED_MODULE_1__["InputType"].mouse)
        );
    }
...
class TouchClickGesture extends _abstract_hammer_gesture__WEBPACK_IMPORTED_MODULE_2__["AbstractHammerGesture"] {
    constructor(element, {tapType = _constants__WEBPACK_IMPORTED_MODULE_1__["TapType"].single, fingers = _constants__WEBPACK_IMPORTED_MODULE_1__["FingersCount"].one, timeout = 1, inputType = _constants__WEBPACK_IMPORTED_MODULE_1__["InputType"].any}) {
        super(element, {
            ...
            initEventOptions: {pointers: fingers, time: tapType === _constants__WEBPACK_IMPORTED_MODULE_1__["TapType"].long ? timeout : 0},
            source: inputType
        });
    }
}
...
/* harmony import */ var _gestures_touch_click__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gestures/touch-click */ "./src/gestures/touch-click.js");
/* harmony import */ var _gestures_mouse_wheel__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./gestures/mouse-wheel */ "./src/gestures/mouse-wheel.js");
/* harmony import */ var _gestures_mouse_over__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./gestures/mouse-over */ "./src/gestures/mouse-over.js");
/* harmony import */ var _gestures_drag_over__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./gestures/drag-over */ "./src/gestures/drag-over.js");
...
function GestureFactory({gestureType, target, options = {}}) {
    ...
    switch (gestureType) {
        case _constants__WEBPACK_IMPORTED_MODULE_0__["GestureType"].TouchClick:
            result = new _gestures_touch_click__WEBPACK_IMPORTED_MODULE_1__["TouchClickGesture"](target, options);
            break;
        case _constants__WEBPACK_IMPORTED_MODULE_0__["GestureType"].MouseOver:
            result = new _gestures_mouse_over__WEBPACK_IMPORTED_MODULE_3__["MouseOverGesture"](target, options);
            break;
        case _constants__WEBPACK_IMPORTED_MODULE_0__["GestureType"].DragOver:
            result = new _gestures_drag_over__WEBPACK_IMPORTED_MODULE_4__["DragOverGesture"](target, options);
            break;
        case _constants__WEBPACK_IMPORTED_MODULE_0__["GestureType"].MouseWheel:
            result = new _gestures_mouse_wheel__WEBPACK_IMPORTED_MODULE_2__["MouseWheelGesture"](target, options);
            break;
        default:
